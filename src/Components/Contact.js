    ...
    <>
      ...
      <div className="container-fluid">
        <div className="row" style={{ padding: "40px 0px", backgroundColor: "#ebf5f9" }}>
          <h1 className='contact-heading' style={{ textAlign: "center" }}>Contact Us</h1>
        </div>
      </div>
          ...
          <div className='col-xl-10' style={{ margin: '80px auto' }}>
            <div className='row' style={{ display: 'flex', justifyContent: "space-evenly" }}>
              ...
              <div className='social-icons-card col-md-2'>
                ...
                <h3><svg width={105} height={105} viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="62.5" cy="62.5" r="62.5" fill="#3882C4" />
                  <path d="M71.8813 86.25L61.7875 76.1563L65.1125 72.8313L71.8813 79.6L85.3 66.1813L88.625 69.5063L71.8813 86.25ZM62.5 60.125L81.5 48.25H43.5L62.5 60.125ZM62.5 64.875L43.5 53V76.75H55.7313L60.4813 81.5H43.5C42.1938 81.5 41.0751 81.0345 40.1441 80.1035C39.2131 79.1725 38.7484 78.0547 38.75 76.75V48.25C38.75 46.9438 39.2155 45.8251 40.1465 44.8941C41.0775 43.9631 42.1953 43.4984 43.5 43.5H81.5C82.8063 43.5 83.9249 43.9655 84.8559 44.8965C85.7869 45.8275 86.2516 46.9453 86.25 48.25V58.5813L81.5 63.3313V53L62.5 64.875Z" fill="white" />
                </svg>
              ...
              <div className='social-icons-card col-md-2'>
                ...
                <h3><svg width={105} height={105} viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="62.5" cy="62.5" r="62.5" fill="#3882C4" />
                  <path d="M50.4467 59.6262C53.8067 66.3475 59.22 71.8337 65.8233 75.2775L70.9567 70.0525C71.5867 69.4113 72.52 69.1975 73.3367 69.4825C75.95 70.3612 78.7733 70.8363 81.6667 70.8363C82.95 70.8363 84 71.905 84 73.2113V81.5C84 82.8063 82.95 83.875 81.6667 83.875C59.7567 83.875 42 65.8013 42 43.5C42 42.1938 43.05 41.125 44.3333 41.125H52.5C53.7833 41.125 54.8333 42.1938 54.8333 43.5C54.8333 46.4688 55.3 49.3188 56.1633 51.9788C56.42 52.81 56.2333 53.7362 55.58 54.4013L50.4467 59.6262Z" fill="white" />
                </svg>
              ...
              <div className='social-icons-card col-md-2'>
                <h3><svg width={105} height={105} viewBox="0 0 125 125" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="62.5" cy="62.5" r="62.5" fill="#3882C4" />
                  <path d="M69.9105 46.6349H74.3755V39.0824C72.2136 38.8576 70.0415 38.7467 67.868 38.7499C61.408 38.7499 56.9905 42.6924 56.9905 49.9124V56.1349H49.6992V64.5899H56.9905V86.25H65.7305V64.5899H72.998L74.0905 56.1349H65.7305V50.7437C65.7305 48.2499 66.3955 46.6349 69.9105 46.6349Z" fill="white" />
                </svg>
      ...
      <div className="container-fluid">
        <div className="row">
          <div className='col-12 form-h-p-container'>
            ...
            <p>For question comments and suggestion, please use this contact form.</p>
          </div>
          <div className='col-xl-9' style={{ margin: '50px auto' }}>
            <form>
              ...
              <div className="form-group phone-container">
                <input type="number" className="form-control" placeholder="Phone Numer" />
              </div>

              <div className="form-group">

                <textarea className="form-control textarera" placeholder="inquiry..." rows="10"></textarea>
              </div>
